...
public class Day17_GoogleSearchStepDefinitions {
    ...
    public void user_in_on_the_google_page() {
        ...
        //Driver.getDriver().findElement(By.xpath("(//div[@class='jyfHyd'])[1]")).click();
    }
    ...
    public void user_search_for(String item) {
        googlePage.googleSearchBox.sendKeys(item + Keys.ENTER);
    }
    @Then("verify the result has {string}")
    public void verify_the_result_has(String item) {
        String title = Driver.getDriver().getTitle();
